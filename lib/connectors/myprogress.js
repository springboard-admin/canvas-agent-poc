...
const tools = [
  ...
  },
  {
    ...
    run: ({ week }, d, cards) => { const url = weekUrl(d.sp, week); if (!url) return { shown: false }; cards.push({ kind: "open", title: `Week ${week}`, url, week, cta: "Open in Canvas →" }); return { shown: true }; },
  },
  {
