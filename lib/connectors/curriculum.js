...
const tools = [
  ...
  {
    def: { name: "show_progress", description: "Render the student's progress card (the week list / focus view). Use when they ask broadly how they're doing.", input_schema: { type: "object", properties: {} } },
